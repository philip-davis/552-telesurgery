...
print(" average tx pkt disp: ", np.average([abs(v) for v in clean_tx_disp]))
print(" average rx pkt disp: ", np.average([abs(v) for v in clean_rx_disp]))
...
print(" average net pkt disp: ", np.average([abs(v) for v in net_disp]))
print(" max net pkt disp: ", max(net_disp))
print(" min net pkt disp: ", min(net_disp))
print(" stdev net pkt disp: ", stdev(net_disp))
print(" average sw rx pkt disp: ", np.average([abs(v) for v in rx_sw_disp]))
print(" max sw rx pkt disp: ", max(rx_sw_disp))
print(" stdev sw rx pkt disp: ", stdev(rx_sw_disp))
print(" average rx stack pkt disp: ", np.average([abs(v) for v in rx_stack_disp]))
...
disp_avg = np.average([abs(v) for v in net_disp])
